...
export const productEmails = {
  ...
  paymentReleased: (d: { amount: string; collabId: string }): ProductEmail => ({
    ...
    preheader: 'Payment released, funds arrive in 1 to 2 business days.',
    title: 'Your live post was confirmed, you got paid',
    body: `Your post was confirmed and ${d.amount} has been released to you. It usually lands in your account within 1 to 2 business days.`,
