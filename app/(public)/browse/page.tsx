...
export async function generateMetadata({
  ...
  const niche = searchParams.niche
    ? NICHE_LABELS[searchParams.niche as CreatorNiche] || searchParams.niche
    : null;
  ...
  return (
    <div style={{ maxWidth: 1140, margin: '0 auto' }} className="space-y-6">
      <div>
        ...
        >
          Some creator profiles are initially prepared using publicly available
          information. Creators may claim their profile at any time to manage,
          update, and personalise it on JoinCollabr.
        </p>
      </div>
