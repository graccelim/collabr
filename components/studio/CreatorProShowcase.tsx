...
export default function CreatorProShowcase({ returnTo = '/studio' }: { returnTo?: string }) {
  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 18 }}>
      {/* hero */}
      <div style={{ position: 'relative', overflow: 'hidden', borderRadius: 20, padding: '34px 30px 30px', background: 'linear-gradient(150deg,#05060E 0%,#10143A 58%,#05060E 100%)', boxShadow: '0 1px 3px rgba(14,16,22,.04),0 30px 60px -34px rgba(20,30,80,.45)' }}>
        <div style={TEXTURE} />
