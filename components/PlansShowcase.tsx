...
export default function PlansShowcase({
  ...
  return (
    <div className="gate-wrap" style={{ maxWidth: 760, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 22 }}>
      {/* hero */}
      <div className="gate-hero" style={{ position: 'relative', overflow: 'hidden', borderRadius: 20, padding: '34px 32px 30px', background: 'linear-gradient(150deg,#05060E 0%,#10143A 58%,#05060E 100%)', boxShadow: '0 1px 3px rgba(14,16,22,.04),0 30px 60px -34px rgba(20,30,80,.45)' }}>
        <div style={TEXTURE} />
        ...
        <div style={{ position: 'relative', maxWidth: 580 }}>
          ...
          <h1 style={{ fontFamily: NUM, margin: '12px 0 9px', fontSize: 'clamp(24px,3.4vw,31px)', fontWeight: 700, letterSpacing: '-.03em', lineHeight: 1.1, color: '#fff' }}>{heading}</h1>
