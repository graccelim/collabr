...
// Brand-coloured glyphs: Simple Icons rendered in each brand's official hex.
...
// Lemon8 isn't in Simple Icons - render its full-colour brand mark.
function Lemon8Glyph({ size = 20, className, ...rest }: SocialIconProps) {
  return (
    <svg
      width={size} height={size} viewBox="0 0 512 512" role="img"
...
const GLYPHS: Record<SocialPlatform, ComponentType<SocialIconProps>> = {
...
/** Full-colour brand glyph for a platform. */
